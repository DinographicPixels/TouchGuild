...
class Webhook {
    ...
    edit(options) {
        return __awaiter(this, void 0, void 0, function* () {
            let response = yield calls.put(endpoints.GUILD_WEBHOOK(this.guildID, this.id), this._client.token, { name: options.name, channelId: options.channelID });
    ...
    delete() {
        return __awaiter(this, void 0, void 0, function* () {
            yield calls.delete(endpoints.GUILD_WEBHOOK(this.guildID, this.id), this._client.token);
        });
    }
}
