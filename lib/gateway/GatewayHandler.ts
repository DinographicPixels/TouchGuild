...
export class GatewayHandler {
    ...
    readonly toHandlerMap: Record<keyof GATEWAY_EVENTS, (data: object) => void> = {
        ...
        ChannelRolePermissionCreated:         data => this.channelHandler.channelRolePermissionCreate(data as GatewayEvent_ChannelRolePermissionCreated),
        ChannelRolePermissionUpdated:         data => this.channelHandler.channelRolePermissionUpdate(data as GatewayEvent_ChannelRolePermissionUpdated),
        ChannelRolePermissionDeleted:         data => this.channelHandler.channelRolePermissionDelete(data as GatewayEvent_ChannelRolePermissionDeleted),
        ChannelUserPermissionCreated:         data => this.channelHandler.channelUserPermissionCreate(data as GatewayEvent_ChannelUserPermissionCreated),
        ChannelUserPermissionUpdated:         data => this.channelHandler.channelUserPermissionUpdate(data as GatewayEvent_ChannelUserPermissionCreated),
        ChannelUserPermissionDeleted:         data => this.channelHandler.channelUserPermissionDelete(data as GatewayEvent_ChannelUserPermissionCreated),
        ...
        ChannelCategoryUserPermissionCreated: data => this.channelHandler.channelCategoryUserPermissionCreate(data as GatewayEvent_ChannelCategoryUserPermissionCreated),
        ChannelCategoryUserPermissionUpdated: data => this.channelHandler.channelCategoryUserPermissionCreate(data as GatewayEvent_ChannelCategoryUserPermissionCreated),
        ChannelCategoryUserPermissionDeleted: data => this.channelHandler.channelCategoryUserPermissionCreate(data as GatewayEvent_ChannelCategoryUserPermissionCreated),
        ChannelCategoryRolePermissionCreated: data => this.channelHandler.channelCategoryRolePermissionCreate(data as GatewayEvent_ChannelCategoryRolePermissionCreated),
        ChannelCategoryRolePermissionUpdated: data => this.channelHandler.channelCategoryRolePermissionUpdate(data as GatewayEvent_ChannelCategoryRolePermissionCreated),
        ChannelCategoryRolePermissionDeleted: data => this.channelHandler.channelCategoryRolePermissionDelete(data as GatewayEvent_ChannelCategoryRolePermissionCreated),
        // Forum Threads
