...
export const GUILD_GROUP_MEMBERS = (groupID: string, memberID: string) => `/groups/${groupID}/members/`
export const GUILD_GROUP = (groupID: string, memberID: string) => `/groups/${groupID}`
